...
export interface TranslationDict {
  ...
  hi: {
    ...
    products: {
      badge: "बेस्ट बैंकिंग प्रोडक्ट्स",
      title: "सबसे ज्यादा कमीशन वाले प्रोडक्ट्स।",
      desc: "100+ से अधिक पार्टनर प्रोडक्ट्स में से चुनें। व्हाट्सएप के माध्यम से लिंक शेयर करें, रियल-टाइम में प्रोग्रेस ट्रैक करें और सीधे पेआउट प्राप्त करें।",
      list: [
        {
          title: "क्रेडिट कार्ड",
    ...
    home: {
        ...
        list: [
          {
            ...
            desc: "बिना किसी खर्चे या छिपे हुए चार्ज के अपना काम शुरू करें। ₹0 इन्वेस्टमेंट, 100% कमाई।",
          },
          {
            title: "100+ भरोसेमंद ब्रांड",
            desc: "HDFC, SBI और Axis जैसे भारत के 100+ सबसे बड़े और भरोसेमंद बैंकों के प्रोडक्ट्स अब एक ही जगह पर।",
          },
          {
            title: "सबसे ज्यादा कमीशन",
            desc: "मार्केट में सबसे ऊंचे कमीशन रेट्स का फायदा उठाएं। आपकी पूरी कमाई बिना किसी देरी के सीधा आपके बैंक खाते में।",
          },
          {
            title: "पूरा सपोर्ट और ट्रेनिंग",
            desc: "हमारी साथी एकेडमी के जरिए हर कदम पर मदद और पूरी ट्रेनिंग पाएं ताकि आप बिना किसी झिझक के काम कर सकें।",
          },
        ],
      },
      howItWorks: {
      ...
      tech: {
        ...
        desc: "हम आपके काम को आसान, तेज़ और अधिक लाभदायक बनाने के लिए अत्याधुनिक तकनीक का उपयोग करते हैं।",
        items: [
          {
            title: "WhatsApp Chat",
    ...
    aboutPage: {
      hero: {
        punchline: "भारत के हर कोने को बेहतर फाइनेंशियल विकल्पों से जोड़ना।",
        hook: "2020 से पूरे भारत में भरोसे का एक नाम।",
        subtext: "भोपाल स्थित हमारे हेडक्वार्टर से, हम हर भारतीय परिवार तक बैंकिंग सुविधाओं को आसान बनाने की एक नई क्रांति ला रहे हैं।",
      },
      legacy: {
        title: "भरोसे का एक लंबा सफर",
        content: "2020 में अपनी शुरुआत के बाद से, paisamilega भारतीय फिनटेक की दुनिया में मजबूती से खड़ा है। पिछले 6 सालों में हमने न सिर्फ अपनी तकनीक को वर्ल्ड-क्लास बनाया है, बल्कि भारत के सबसे बड़े बैंकों के साथ अटूट रिश्ते भी जोड़े हैं। हमारा असली सफर हमारे उन हजारों साथियों की कामयाबी से जुड़ा है, जिन्होंने हमारे साथ जुड़कर अपनी लाइफ को बेहतर बनाया है।",
      },
      stats: [
        { label: "रजिस्टर्ड साथी", value: "1,000+" },
        { label: "एक्सपर्ट टीम मेंबर्स", value: "100+" },
        { label: "बैंकिंग पार्टनर्स", value: "100+" },
      ],
      team: {
        title: "Paisa Milega का दिल",
        content: "100 से अधिक एक्सपर्ट्स की हमारी इन-हाउस टीम दिन-रात काम करती है ताकि आपकी हर लीड और हर पेमेंट (payout) पूरी तरह सुरक्षित और समय पर हो। भोपाल ऑफिस में बैठकर हमारी टीम पूरे देश के साथियों को सशक्त बनाने का सपना देखती है। हम पारदर्शिता और स्पीड में विश्वास रखते हैं, ताकि आप हर दिन बिना किसी रुकावट के आगे बढ़ सकें।",
      },
      mission: {
        title: "हमारा मिशन",
        content: "अगले अरब भारतीयों के लिए एक ऐसा डिजिटल सेतु (bridge) बनना, जो हर घर तक प्रोफेशनल बैंकिंग सर्विसेज को आसानी से पहुंचा सके।",
      },
      vision: {
        title: "हमारा विजन",
        content: "हर भारतीय को डिजिटल टूल्स और सही जानकारी से लैस करना, ताकि वो आर्थिक रूप से स्वतंत्र हो सकें और अपनी वेल्थ (wealth) बढ़ा सकें।",
      },
      lifeAt: {
